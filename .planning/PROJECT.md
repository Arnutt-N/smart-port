...
## Current State (Phase 06 complete 2026-03-23)

- **LOC**: ~7,100 (Vue/JS ~4,400 + PHP ~1,800 + SQL 849)
- **Database**: 42 tables, 4 views in MySQL 8.0 — v1.1 migration adds ratio_percent + GENERATED diff_count + 14 seed rows
- **API**: Candidate qualification engine + Probation CRUD + Supportive/Diverse/Equivalence CRUD
- **Frontend**: Vue 3 SPA with 5 candidate tabs + probation page + 3 new CRUD pages (supportive, diverse, equivalence)
- **UAT**: Phase 01 (3/3 passed), Phase 03 (5/5 passed)
- **Phase 06**: Frontend CRUD pages complete — 3 Vue pages with modal forms, personnel autocomplete, approval workflow, Thai UI
...
---
*Last updated: 2026-03-23 after Phase 06 frontend-crud-pages complete*
