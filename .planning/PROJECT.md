...
- [ ] MySQL schema for career path / candidate list tables (convert from PostgreSQL syntax in gap_analysis_career_path_v2.sql)
- [ ] MySQL schema for probation tracking tables (convert from PostgreSQL syntax in probation_tracking_schema.sql)
...
- [ ] Seed data for promotion_criteria (เกณฑ์คุณสมบัติ O1→O2, O2→O3, K1→K2, K2→K3, K3→K4)
