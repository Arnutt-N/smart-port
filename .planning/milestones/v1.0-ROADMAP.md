...
- [x] 03-02-PLAN.md — CandidateListsPage rewrite with overview dashboard, pill sub-tabs, live API data, search, pagination
- [x] 03-03-PLAN.md — ProbationEndPage rewrite with live stat cards, color-coded days, search, pagination
