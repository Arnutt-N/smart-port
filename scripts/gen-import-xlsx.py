...
build('frontend/public/import-template.xlsx', {
    'Personnel':   [['1100100200009', 'สมชาย(ตัวอย่าง-ลบก่อนใช้)', 'ใจดี', '2010-01-01', 'K3', '2020-01-01', 'MASTER', 'สำนักงานปลัดกระทรวงยุติธรรม', 'นักทรัพยากรบุคคลชำนาญการพิเศษ']],
    'Diverse':     [['1100100200009', '1', '1', '1', '0', '2018-01-01']],
    'Equivalence': [['1100100200009', 'ผู้เชี่ยวชาญ', 'อำนวยการ', '730', 'APPROVED', '2020-01-01', '2022-01-01']],
    'History':     [['1100100200009', 'K3', '2016-01-01', '2020-01-01', 'ชำนาญการพิเศษ', 'สำนักงานปลัดกระทรวงยุติธรรม']],
})

# ข้อมูลทดสอบ: 299005 = M1 (K3+3ปี+3ต่าง → 2023-01-01), 299013 = S2 (S1+1ปี → 2023-01-01)
build('backend/tests/fixtures/import-sample.xlsx', {
    'Personnel': [
        ['1100100299005', 'สมหมาย', 'ทดสอบนำเข้า', '2010-01-01', 'K3', '2020-01-01', 'MASTER', 'กองบริหารทรัพยากรบุคคล', 'นักทรัพยากรบุคคลชำนาญการ'],
        ['1100100299013', 'สมศรี', 'ทดสอบนำเข้า', '2008-01-01', 'S1', '2022-01-01', 'MASTER', 'กองบริหารทรัพยากรบุคคล', 'ผู้อำนวยการกอง'],
    ],
    'Diverse':     [['1100100299005', '1', '1', '1', '0', '2018-01-01']],
    'Equivalence': [],
    'History':     [],
})
