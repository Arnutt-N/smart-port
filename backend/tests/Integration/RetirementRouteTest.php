...
/**
 * Integration tests for the retirement report route helper — seeds a personnel row with a near-term
 * retirement_date and checks the list shape + computed remaining_days. Read-only route.
 * Skips when MySQL or the personnel table is unavailable.
 */
final class RetirementRouteTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        self::$pdo->prepare(
            'INSERT INTO personnel (employee_id, citizen_id, first_name, last_name, birth_date, appointment_date, retirement_date, is_active)
