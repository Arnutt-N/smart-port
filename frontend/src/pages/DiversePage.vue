    ...
    <div class="flex items-center justify-between mb-6">
      <div>
        ...
        <p class="text-sm text-gray-500 mt-1">
          บันทึกประสบการณ์แตกต่าง 4 มิติ
        </p>
      </div>
      <button
        ...
        <table class="w-full">
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-6 py-3 text-sm text-gray-700">
                {{ row.fromJobSeries }} / {{ row.fromProvince }}
              </td>
              <td class="px-6 py-3 text-sm text-gray-700">
                {{ row.toJobSeries }} / {{ row.toProvince }}
              </td>
        ...
        >
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            ...
            <div class="space-y-3">
              ...
              <div>
                <label
                  for="diverse-from-job-series"
                  class="block text-sm font-medium text-gray-700 mb-1"
                >สายงาน <span class="text-red-500">*</span></label>
                <input
                ...
                >
                <p
                  v-if="validationErrors.from_job_series"
                  class="text-red-500 text-xs mt-1"
                >
                  {{ validationErrors.from_job_series }}
                </p>
              </div>
              <div>
                <label
                  for="diverse-from-work-group"
                  class="block text-sm font-medium text-gray-700 mb-1"
                >กลุ่มงาน</label>
                <input
                  id="diverse-from-work-group"
                  v-model="formData.from_work_group"
                  type="text"
                  class="input"
                >
              </div>
              <div>
                <label
                  for="diverse-from-division"
                  class="block text-sm font-medium text-gray-700 mb-1"
                >ส่วน/ฝ่าย</label>
                <input
                  id="diverse-from-division"
                  v-model="formData.from_division"
                  type="text"
                  class="input"
                >
              </div>
              <div>
                <label
                  for="diverse-from-province"
                  class="block text-sm font-medium text-gray-700 mb-1"
                >จังหวัด</label>
                <input
                  id="diverse-from-province"
                  v-model="formData.from_province"
                  type="text"
                  class="input"
                >
              </div>
            ...
            <div class="space-y-3">
              ...
              <div>
                ...
                >
                <p
                  v-if="validationErrors.to_job_series"
                  class="text-red-500 text-xs mt-1"
                >
                  {{ validationErrors.to_job_series }}
                </p>
              </div>
              <div>
                <label
                  for="diverse-to-work-group"
                  class="block text-sm font-medium text-gray-700 mb-1"
                >กลุ่มงาน</label>
                <input
                  id="diverse-to-work-group"
                  v-model="formData.to_work_group"
                  type="text"
                  class="input"
                >
              </div>
              <div>
                <label
                  for="diverse-to-division"
                  class="block text-sm font-medium text-gray-700 mb-1"
                >ส่วน/ฝ่าย</label>
                <input
                  id="diverse-to-division"
                  v-model="formData.to_division"
                  type="text"
                  class="input"
                >
              </div>
              <div>
                <label
                  for="diverse-to-province"
                  class="block text-sm font-medium text-gray-700 mb-1"
                >จังหวัด</label>
                <input
                  id="diverse-to-province"
                  v-model="formData.to_province"
                  type="text"
                  class="input"
                >
              </div>
          ...
          <div class="mt-4 p-4 bg-gray-50 rounded-lg">
            ...
            <div class="grid grid-cols-2 gap-3">
              <label class="flex items-center gap-2">
                <input
                  id="diverse-diff-job-series"
                  v-model="formData.is_diff_job_series"
                  type="checkbox"
              ...
              <label class="flex items-center gap-2">
                <input
                  id="diverse-diff-location"
                  v-model="formData.is_diff_location"
                  type="checkbox"
                  class="rounded text-primary-600"
                >
              ...
              <label class="flex items-center gap-2">
                <input
                  id="diverse-diff-work-nature"
                  v-model="formData.is_diff_work_nature"
                  type="checkbox"
                  class="rounded text-primary-600"
                >
